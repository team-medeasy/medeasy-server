...
public class CurrentRoutineStrategy implements RoutineDateRangeStrategy{
    ...
    public List<RoutineGroupDateRangeDto> findRoutineGroupDateRanges(Long userId, LocalDate startDate, LocalDate endDate) {
        return routineQueryRepository.findCurrentRoutineStartAndEndDateRangeByGroup(userId, startDate, endDate);
    }
}
